...
export const Sidebar=({active,toggler})=>{
    ...
    return <div className="flex z-[50] fixed bottom-0 bg-gray-50 overflow-x-auto border-t border-slate-200 bg-white  p-2 justify-between w-full desktop:justify-start desktop:flex-col desktop:h-screen desktop:w-[15%] desktop:space-y-3 desktop:border-r desktop:border-slate-200 desktop:px-3 text-sm">
...
<button className={`flex absolute bottom-[20px]  p-3 items-center select-none desktop:space-x-5  rounded-md duration-400 text-red-600`} onClick={handleLogout}>
